package com.pichs.xdialog.utils;
...
public class DialogTimer {
    ...
    private DialogTimer(Handler handler, long delay, long period) {
        this.mDelay = delay;
        this.mPeriod = period;
     ...
     */
    public DialogTimer(Handler handler, long delay, long period, int times) {
